...
entry to that masternode list after the owner created a 1000 GoByte UTXO and the masternode broadcast
...
transaction which includes either a 1000-GoByte collateral payment or a reference to it, along with
...
- [`cb37c3972`](https://github.com/gobytecoin/gobyte/commit/cb37c3972) Bump PROTOCOL*VERSION to 70211, bump MIN*\* protocols to 70210 (#2256)
