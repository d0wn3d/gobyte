...
provided in [DIP-0020](https://github.com/gobytecoin/dips/blob/master/dip-0020.md).
...
provided in [DIP-0021](https://github.com/gobytecoin/dips/blob/master/dip-0021.md).
...
We reintroduced [Intra-Quorum Connections](https://github.com/gobytecoin/dips/blob/master/dip-0006.md#intra-quorum-communication)
...
This version includes a [backport](https://github.com/gobytecoin/gobyte/pull/2515)
...
See detailed [set of changes](https://github.com/gobytecoin/gobyte/compare/v0.16.1.1...gobytecoin:v0.17.0.2).
