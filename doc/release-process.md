...
By default, Gitian will fetch source files as needed. To cache them ahead of time, make sure you have checked out the tag you want to build in gobyte, then:
...
space _do not upload these to the gobyte.network server_.
