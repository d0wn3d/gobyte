...
Copy network.gobyte.gobyted.plist into ~/Library/LaunchAgents. Load the launch agent by
running `launchctl load ~/Library/LaunchAgents/network.gobyte.gobyted.plist`.
...
You will need to modify network.gobyte.gobyted.plist if you intend to use it as a
