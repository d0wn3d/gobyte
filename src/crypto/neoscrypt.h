...
void neoscrypt_fastkdf_4way(const unsigned char *password,
                            ...
                            unsigned char *scratchpad, const unsigned int mode);
#endif
...
/* EVERYTHING BELOW THIS LINE IS HIDDEN FROM C++ COMPILER (hash.cpp) */
#if !(__cplusplus)
...
/* Macros moved here to prevent collision with hash.cpp functions */
#ifndef ROTL32
