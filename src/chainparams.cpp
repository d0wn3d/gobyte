...
public:
    CMainParams() {
        ...
        consensus.nBudgetPaymentsCycleBlocks = 17280; // ~(60*24*30)/2.6, actual number of blocks per month is 200700 / 12 = 16725
        consensus.nBudgetPaymentsWindowBlocks = 100;
        consensus.nSuperblockStartBlock = 162592; // The block at which 12.1 goes live (end of final 12.0 budget cycle)
        consensus.nSuperblockStartHash = uint256S("0000000000308a40afb7d54bf4b7a159170e558017fd36646536c56813aa33a1");
        consensus.nSuperblockCycle = 17280; // ~(60*24*30)/2.5, actual number of blocks per month is 200700 / 12 = 16725
        ...
        consensus.DIP0008Height = 1585569;
        ...
        // consensus.nPowKGWHeight = 15200; // Dash legacy - GoByte doesn't use this.
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nStartTime = 1767225600; // January 1, 2026
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nTimeout = 1785542400; // August 1st, 2026
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000000089428a7170c9cbc"); // 1450000

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000000658df97974bf64b87ddd1455b86743ffd1ec56bfb9b1878aaeb5dc8de"); // 1533728
        ...
        checkpointData = {
            {
                ...
                {1533728, uint256S("0x0000000658df97974bf64b87ddd1455b86743ffd1ec56bfb9b1878aaeb5dc8de")},
            }
        };

        chainTxData = ChainTxData{
            1770124817, // * UNIX timestamp of last known number of transactions (Block 858200)
            2500897,   // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        consensus.DIP0008Height = 125000; // CHECK BACK LATER
        ...
        consensus.fPowNoRetargeting = false;
        // consensus.nPowKGWHeight = 4002; // nPowKGWHeight >= nPowDGWHeight means "no KGW" | Dash legacy code, not needed.
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].bit = 6;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nStartTime = 1767225600; // January 1, 2026
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nTimeout = 1767225600; // January 1, 2026
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        //consensus.nPowKGWHeight = 4001; // nPowKGWHeight >= nPowDGWHeight means "no KGW" | Dash legacy code
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("339500f3a84f1d4231087409104fafda47e652bd7e5301d343ceb60ed501c5ac"));
        assert(genesis.hashMerkleRoot == uint256S("0xdc9a719dc1bcda39107ea55424f00cab512170a1cb69efa08531f483f2399f21"));
        ...
        // Devnet GoByte addresses start with 'n'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,112);
        // Devnet GoByte script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,20);
        // Devnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,240);
        // Devnet GoByte BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Devnet GoByte BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Devnet GoByte BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
        ...
        //consensus.nPowKGWHeight = 15200; // same as mainnet | Dash legacy code
