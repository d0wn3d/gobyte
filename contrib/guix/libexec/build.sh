...
(
    ...
    sed -i.old 's/-lstdc++ //g' {./,src/gobytebls/,src/secp256k1/}{config.status,libtool}
    ...
    # Setup the directory where our GoByte Core build for HOST will be
    # installed. This directory will also later serve as the input for our
    # binary tarballs.
    INSTALLPATH="${PWD}/installed/${DISTNAME}"
    mkdir -p "${INSTALLPATH}"
    # Install built GoByte Core to $INSTALLPATH
    ...
    (
        ...
        # copy over the example gobyte.conf file. if contrib/devtools/gen-gobyte-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/contrib/debian/examples/gobyte.conf" "${DISTNAME}/"
